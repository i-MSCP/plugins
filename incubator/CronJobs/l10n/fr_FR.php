...
return array(
	...
	'You can learn more about the syntax by reading:' => "Vous pouvez en apprendre d'avantage sur la syntaxe utilisée en lisant:",
	...
	"Wrong value for the 'Max. cron jobs' field. Please, enter a number." => "Mauvaise valeur pour le champ 'Nombre max. de tâche cron'. Veuillez entrer un nombre.",
	...
	'The cron jobs frequency is lower than your own limit which is currently set to %s minute.' => array(
		"La fréquence des tâches cron est plus petite que votre propre limite, laquelle est actuellement de %s minute.",
		"La fréquence des tâches cron est plus petite que votre propre limite, laquelle est actuellement de %s minutes." // Plural form
	),
	'Cron job permissions were added.' => 'Les permissions cron ont été ajoutées.',
	'Cron job permissions were updated.' => 'Les permissions cron ont été mises à jour.',
	...
	'Cron job permissions were revoked.' => 'Les permissions cron ont été révoquées.',
	...
	'Unlimited' => 'Illimité',
	'Admin / Settings / Cron Job Permissions' => 'Admin / Paramètres / Permissions cron',
	'List of resellers which are allowed to give cron job permissions to their customers.' => 'Liste des revendeurs qui sont autorisés à donner des permissions cron à leur clients.',
	'Reseller name' => 'Nom du revendeur',
	'Cron jobs type' => 'Type de tâches cron',
	'Cron jobs frequency' => 'Fréquence des tâches cron',
	'Add / Edit cron job permissions' => 'Ajout / Édition des permissions cron',
	...
	'Are you sure you want to revoke the cron job permissions for this reseller?' => 'Êtes-vous certain de vouloir révoquer les permissions cron pour ce revendeur?',
	...
	'Are you sure you want to revoke the cron job permissions for this customer?' => 'Êtes-vous certain de vouloir révoquer les permissions cron pour ce client?',
