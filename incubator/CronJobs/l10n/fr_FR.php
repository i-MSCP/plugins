...
return array(
	...
	'This is the interface from which you can add your own cron jobs. This interface is for administrators only. Customers have their own interface which is more restricted.' => "Interface à partir de laquelle vous pouvez ajouter vos propres tâches cron. Cette interface est réservée aux administrateurs. Les clients ont leur propre interface, laquelle est plus restreinte.",
