...
return array(
	...
	'An SSH user with the same name or the same SSH key already exists.' => 'This SSH key is already assigned to another SSH user.',
	...
	'Wrong password length (Min 6 characters).' => 'Wrong password length (Min 8 characters).',
