...
return array(
	...
	'This is the list of SSH public keys associated with your account. Remove any keys that you do not recognize.' => 'Liste der öffentlichen SSH Schlüssel welche mit ihrem Account verbunden sind. Entfernen Sie alle Schlüssel, die Sie nicht kennen.',
	...
	'User' => 'Benutzer',
	'Arbitrary name which allow you to retrieve your SSH key.' => 'Ein beliebiger Name, welcher es Ihnen erlaubt, ihren SSH Schlüssel wieder zu finden.',
	'SSH Key name' => 'SSH Schlüssel Name',
	'SSH Key' => 'SSH Schlüssel',
	'Enter a key name' => 'Gebe einen Schlüsselnamen ein',
	'Supported RSA key formats are PKCS#1, openSSH and XML Signature.' => 'Unterstützte RSA Schlüssel Formate sind PKCS#1, openSSH und XML Signatur.',
	'Enter a key' => 'Gebe einen Schlüssel ein',
	'Are you sure you want to delete this SSH key? Be aware that this will destroy all your SSH sessions.' => 'Sind Sie sicher, dass Sie diesen SSH Schlüssel löschen wollen? Dies wird alle ihre SSH Sessions löschen.',
	'Client / Profile / SSH Keys' => 'Kunde / Profil / SSH Schlüssel',
	'SSH Key not found.' => 'SSH Schlüssel nicht gefunden.',
	'Un-allowed SSH key name. Please use alphanumeric and space characters only.' => 'Unzulässiger SSH Schlüssel Name. Bitte benutzen Sie nur Alphanumerische Zeichen und das Leerzeichen.',
	...
	'Your SSH key limit is reached.' => 'Ihr SSH Schlüssel Limit ist erreicht.',
