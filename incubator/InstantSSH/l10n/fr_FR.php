...
return array(
	...
	'Your i-MSCP version is not compatible with this plugin. Try with a newer version.' => "Votre version d'i-MSCP n'est pas compatible avec ce plugin. Veuillez essayez avec une version plus récente.",
	...
	"Wrong value for the 'Maximum number of SSH keys' field. Please, enter a number." => "Valeur errorée pour le champ 'Nombre de clés SSH'. Veullez entrer un nombre.",
	...
	'Add / Edit SSH keys' => 'Ajout / Edition des clés SSH',
