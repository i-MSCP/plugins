...
return array(
	...
	"Wrong value for the 'Maximum number of SSH keys' field. Please, enter a number." => "Valeur errornée pour le champ 'Nombre de clés SSH'. Veullez entrer un nombre.",
