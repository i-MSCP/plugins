...
return array(
	...
	'Can edit authentication options' => 'Kan redigera autentiseringsalternativ',
	...
	'An unexpected error occurred: %s' => 'Ett oväntat fel inträffade:',
	'SSH permissions not found.' => 'SSH behörigheter hittades inte.',
	'Bad request' => 'Bad begäran',
	'All fields are required.' => 'Alla fält är obligatoriska.',
	"Wrong value for the 'Maximum number of SSH keys' field. Please, enter a number." => "Fel värde för 'Maximalt antal SSH-nycklar' fältet. Vänligen, ange en siffra.",
	'SSH permissions scheduled for addition.' => 'SSH behörigheter planerad till tillägg.',
	'SSH permissions were scheduled for update.' => 'SSH tillstånd var planerade för uppdatering.',
	'SSH permissions were scheduled for deletion.' => 'SSH tillstånd var planerade för radering.',
	...
	'SSH key name is too long (Max 255 characters).'=> 'SSH-nyckel namnet  är förlångt (max 255 tecken).',
