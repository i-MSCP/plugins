...
return array(
	'up' => "
		CREATE TABLE IF NOT EXISTS instant_ssh_users (
			...
			ssh_user_password varchar(255) COLLATE utf8_unicode_ci NULL DEFAULT NULL,
			ssh_user_key text NULL DEFAULT NULL,
			ssh_user_key_fingerprint varchar(255) COLLATE utf8_unicode_ci NULL DEFAULT NULL,
			ssh_user_auth_options text NULL DEFAULT NULL,
