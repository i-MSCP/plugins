...
return array(
    ...
    'No graph for your selection is available.' => 'No graph for your selection is available.',
    'An error occured while opening the directory: %s' => 'An error occured while opening the directory: %s'
);
