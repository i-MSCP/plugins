...
namespace ServerProvisioning\DomainAlias;

use ServerProvisioning\Controller\DomainAlias;

/**
 * Class Sanity
 *
 * @package ServerProvisioning\DomainAlias
 */
class Sanity extends DomainAlias
{
