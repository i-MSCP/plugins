...
$rcmail_config['markasjunk2_spam_dir'] = '{GUI_ROOT_DIR}/plugins/SpamAssassin/sa-learn';

// The full path of the directory used to store ham (must be writable by webserver)
$rcmail_config['markasjunk2_ham_dir'] = '{GUI_ROOT_DIR}/plugins/SpamAssassin/sa-learn';
...
$rcmail_config['markasjunk2_filename'] = '%u__%t__';
